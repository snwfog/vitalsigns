 ...
 * of this value object you may modify the generated sub-class of this class - ImageDTO.as.
 */
...
[ExcludeClass]
public class _Super_ImageDTO extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    private var _internal_image : ByteArray;
    private var _internal_imageId : int;
    private var _internal_originalName : String;
    ...
    {
        var oldValue:ByteArray = _internal_image;
        if (oldValue !== value)
        {
    ...
    {
        var oldValue:String = _internal_originalName;
        if (oldValue !== value)
        {
            _internal_originalName = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "originalName", oldValue, _internal_originalName));
        }
    }
    ...
    {
        var oldValue : _ImageDTOEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
