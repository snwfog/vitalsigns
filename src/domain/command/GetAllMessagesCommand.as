package domain.command
{
	...
	public class GetAllMessagesCommand extends Command
	{
		private var _user:User;
		private var _assembler:ConversationAssembler;
		
		public function GetAllMessagesCommand( observable:IObservable, user:User ){
			super( observable );
			_user = user;
		...
		override public function execute():void{
			...
			ws.getAllMessagesByUser( userAssembler.createDataTransferObject( _user ) as UserDTO );
		}
